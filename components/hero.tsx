    ...
    <section className="pt-24 pb-16 px-6 min-h-[92vh] flex items-center">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        >
          ...
          <motion.h1
            variants={fadeInUp}
            className="font-headline text-4xl lg:text-5xl font-bold leading-[1.3] mb-5"
          >
            {h.headline}{" "}
          ...
          <motion.p
            variants={fadeInUp}
            className="text-base text-on-surface-variant max-w-lg mb-7 leading-relaxed"
          >
            {h.sub}
          </motion.p>
        ...
        >
            ...
            <div className="bg-surface">
              ...
              <div className="flex items-center justify-between px-4 py-2.5 border-b border-outline">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[7px] bg-primary text-white px-2 py-0.5 rounded font-bold">{t.nav.cta}</span>
                </div>
              </div>
              ...
              <div className="px-4 pt-4 pb-3 flex gap-3 items-center">
                <div className="flex-1">
                  <div className="text-[7px] text-primary font-bold tracking-widest uppercase mb-1.5">{h.eyebrow}</div>
                  ...
                  <div className="flex gap-1.5 mb-2">
                    <span className="text-[7px] bg-primary text-white px-2.5 py-1 rounded font-bold">💬 {h.ctaPrimary}</span>
                    <span className="text-[7px] border border-outline text-on-surface-variant px-2.5 py-1 rounded font-medium">{h.ctaSecondary}</span>
                  </div>
              ...
              <div className="px-4 pb-3">
                <div className="text-[7px] font-bold text-on-surface mb-2 uppercase tracking-widest">{t.services.headline}</div>
                <div className="grid grid-cols-3 gap-1.5">
                  {[
                    { icon: "🌐", title: t.services.items[0].title, color: "bg-primary/10" },
                    { icon: "🛍️", title: t.services.items[2].title, color: "bg-success/10" },
                    { icon: "🤖", title: t.services.items[4].title, color: "bg-gold/10"    },
                  ].map(s => (
              ...
              <div className="flex border-t border-outline">
                {t.techStack.stats.map(s => (
                  <div key={s.label} className="flex-1 bg-primary/5 px-3 py-2 text-center border-r last:border-r-0 border-outline">
                    <div className="text-[9px] font-black text-on-surface">{s.value}</div>
          ...
          >
            ...
            <div>
              <div className="text-xs font-bold text-on-surface">{h.mockBadge}</div>
              <div className="text-[10px] text-on-surface-variant">{h.mockBadgeSub}</div>
            </div>
          </motion.div>
